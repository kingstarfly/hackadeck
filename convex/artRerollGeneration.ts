...
function errorMessage(error: unknown) {
  ...
  return "That new look wandered off. Please try again.";
}
...
export const generateForRun = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      await ctx.runMutation(internal.artRerollState.completeArtReroll, {
        runId: args.runId,
        avatarImageUrl,
      });
      ...
      await ctx.runMutation(internal.artRerollState.failArtReroll, {
        runId: args.runId,
