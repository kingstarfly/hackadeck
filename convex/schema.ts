...
export const cardSpecValidator = v.object({
  ...
  hatched_at_label: v.optional(v.string()),
  earned_title: v.string(),
  archetype_base: v.string(),
  card_intent: v.string(),
  familiar_species: v.string(),
  familiar_descriptor: v.string(),
  personal_relic: v.object({
    name: v.string(),
    visual: v.string(),
    meaning: v.string(),
  }),
  ...
  stat_icons: v.object({
    Build: v.union(v.literal("hammer"), v.literal("spark"), v.literal("stack")),
    Debug: v.union(
      v.literal("bug"),
      v.literal("magnifier"),
      v.literal("lantern"),
    ),
    Taste: v.union(v.literal("star"), v.literal("leaf"), v.literal("eye")),
    Chaos: v.union(v.literal("bolt"), v.literal("swirl"), v.literal("comet")),
  }),
  ...
  field_note: v.string(),
  known_for: v.optional(v.string()),
  chaos_tell: v.optional(v.string()),
  quirk_phrase: v.optional(v.string()),
